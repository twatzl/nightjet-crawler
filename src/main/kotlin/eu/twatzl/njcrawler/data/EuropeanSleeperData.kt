...
var es452 = if (today <= LocalDate(2024, 3, 24))
    TrainConnection("ES 452", esBerlinOst, esBruxelles) // until March 24, 2024
else TrainConnection("ES 452", esPraha, esBruxelles) // starting from March 26, 2024

val es453 = if (today <= LocalDate(2024, 3, 22))
    TrainConnection("ES 453", esBruxelles, esBerlinOst) // until March 22, 2024
else TrainConnection("ES 453", esBruxelles, esPraha) // starting from March 25, 2024
